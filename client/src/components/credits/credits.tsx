    ...
    render() {
        return <div className="padding-left-right">
            ...
            <ul className="no-margin-top">
                ...
                <li>
                    jerairrest for his <a href="https://github.com/jerairrest/react-chartjs-2">React
                    Chart.js</a> wrapper
                </li>
            ...
            <ul className="no-margin-top">
                ...
                <li>YousefED for the <a href="https://github.com/YousefED/typescript-json-schema"> json schema
                    creation</a>
                </li>
            </ul>
